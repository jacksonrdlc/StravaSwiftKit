...
//  StravaSwiftKit
//
//  Created by Jack Rudelic on 20/05/2016.
//  Copyright © 2016 Jack Rudelic. All rights reserved.
//

import UIKit
import StravaSwiftKit
...
class AthleteViewController: UIViewController {
    ...
    @IBAction func A_upload(_ sender: Any) {
        ...
        let params = StravaSwiftKit.UploadData(activityType: .ride, name: "test1", description: "upload test", private: false, trainer: nil, externalId: nil, dataType: .gpx, file: fileData)
